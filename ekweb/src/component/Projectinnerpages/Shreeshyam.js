...
const Shreeshyam = () => {
  ...
  const content = {
    videoSrc: "/shyam-video.mp4",
    videoAlt: "Shree Shyam Aerocity",
  };
  const shyamimages = [
    {
      img: "/townshipimg2.webp",
    },
    {
      img: "/township3.webp",
    },
  ...
  return (
    <div>
      ...
      <div className="project_container_backdiv">
        {data.Shreeshyam.map((NewData, index) => {
          return (
              ...
              >
                {shyamimages.map((item, index) => (
                  <SwiperSlide key={index}>
                    <img className="township_img" src={item.img} alt="Plots Near Khatu Shyam" loading="lazy"
                    />
                  </SwiperSlide>
                ))}
              </Swiper>
                ...
                <div key={index} className="project_contentdiv">
                  <div className="listgrid">
                    ...
                    <div className="mt-3">
                      ...
                      <p className="listingtext">6 - 50 Lac</p>
                    </div>
                  </div>
          ...
          <div>
            ...
            <div className="project_layout">
              <img
                ...
                src="/townshipsitelayout1.webp"
                alt="Shree Shyam Township Map"
              />
            </div>
          </div>
        </div>
        ...
        <div className="feature_div">
          ...
          <div className="feature_list_grid">
            <div className="list_div">
              {data.Shreeshyam[0].features1.map((feature, index) => (
            ...
            <div className="list_div">
              {data.Shreeshyam[0].features2.map((feature, index) => (
                <div key={index} className="feature_list">
                  <div className="check1_div">
                    <IoIosCheckmark className="check_icon" />
                  </div>
