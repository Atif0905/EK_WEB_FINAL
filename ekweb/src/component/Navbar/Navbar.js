import React, { useState, useEffect } from 'react';
    ...
    const Navbar = () => {
        ...
        const isProjectActive = ['/project', '/Jewar', '/shree-shyam-township', '/shree-shyam-aerocity', '/bliss-valley', "/ekakshar-green-woods", "/ekakshar-green-farms"]
            .includes(location.pathname);

            const isBlogActive = ['/our-blogs', '/top-5-real-estate-growth-zones-to-invest-in-delhi-ncr-with-ekakshar-buildtech', '/discover-16-way-ai-is-making-real-estate-smarter', '/jewar-airport-first-plane-landing-a-milestone-in-aviation-and-infrastructure-development']
            .includes(location.pathname);
        return (
            <nav>
